...
if page == "Home":
    st.markdown("<h1 style='color: #4169E1 !important; font-size: 2.5rem; text-align: center; font-weight: 800; margin-bottom: 8px;'>Student Academic Risk Predictor</h1>", unsafe_allow_html=True)
